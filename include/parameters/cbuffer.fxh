#ifndef __CBUFFER_FXH
#define __CBUFFER_FXH
...
#define _TEXTURE_AND_SAMPLER(_type, _name, _slot)										\
	_SAMPLER(_name##_sampler, _slot)													\
	_TEXTURE(_type, _name##_texture, _slot)												\
	static _TEXTUREANDSAMPLERTYPE##_type _name={ _name##_sampler, _name##_texture };
#define _TEXTURE_USING_SAMPLER(_type, _name, _slot, _sampler)							\
	_TEXTURE(_type, _name##_texture, _slot)												\
	static _TEXTUREANDSAMPLERTYPE##_type _name={ _sampler, _name##_texture };
...
#define RW_BYTE_ADDRESS_BUFFER(_name, _c_name, _slot) RWByteAddressBuffer _name : register(u##_slot);
#define BUFFER(_name, _c_name, _type, _slot) Buffer<_type> _name : register(t##_slot);
#define RW_BUFFER(_name, _c_name, _type, _slot) RWBuffer<_type> _name : register(u##_slot);
