...
s_vertex_output_screen_tex default_vs_tex(const in s_screen_vertex input)
{
	...
	output.texcoordInner.xy = input.texcoord + vs_texture_size.zw * float2(0.0f, offset[1]);
	output.texcoordInner.zw = input.texcoord + vs_texture_size.zw * float2(0.0f, offset[2]);
	output.texcoordOuter.xy = input.texcoord + vs_texture_size.zw * float2(0.0f, offset[0]);
	output.texcoordOuter.zw = input.texcoord + vs_texture_size.zw * float2(0.0f, offset[3]);
