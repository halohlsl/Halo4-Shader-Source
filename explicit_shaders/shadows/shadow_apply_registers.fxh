...
DECLARE_PARAMETER(float4x4, view_inverse_matrix, k_register_view_inverse_matrix);
DECLARE_PARAMETER(float4, occlusion_spheres[k_maximum_occlusion_sphere_count * k_occlusion_sphere_stride], k_register_occlusion_sphere_start);
DECLARE_PARAMETER(int, occlusion_spheres_count, k_register_occlusion_sphere_count);
