...
DECLARE_PARAMETER(sampler2D, ps_source_lowres_sampler, s1);
DECLARE_PARAMETER(sampler2D, ps_palette_sampler, s2);
...
PIXEL_TEXTURE_AND_SAMPLER(_2D,	ps_source_sampler, 				k_ps_lit_particle_overdraw_source_sampler,				0)
PIXEL_TEXTURE_AND_SAMPLER(_2D,	ps_source_lowres_sampler, 		k_ps_lit_particle_overdraw_source_lowres_sampler,		1)
PIXEL_TEXTURE_AND_SAMPLER(_2D,	ps_palette_sampler, 			k_ps_lit_particle_overdraw_palette_sampler,				2)
