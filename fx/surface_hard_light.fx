		...
		inout s_shader_data shader_data)
{
	...
	float4 fxMapASample = sample2D(fx_map_a, transform_texcoord(uv, fx_map_a_transform));
	float4 fxMapBSample = sample2D(fx_map_b, transform_texcoord(uv, fx_map_b_transform));
